...
; taken from: https://data.iana.org/TLD/tlds-alpha-by-domain.txt
(def top-level-domain-labels
  #{"aaa" "aarp" "abb" "abbott" "abbvie" "abc" "able" "abogado" "abudhabi" "ac"
    "academy" "accenture" "accountant" "accountants" "aco" "actor" "ad" "ads"
    "adult" "ae" "aeg" "aero" "aetna" "af" "afl" "africa" "ag" "agakhan"
    ...
    "audi" "audible" "audio" "auspost" "author" "auto" "autos" "aw" "aws" "ax"
    "axa" "az" "azure" "ba" "baby" "baidu" "banamex" "band" "bank" "bar"
    "barcelona" "barclaycard" "barclays" "barefoot" "bargains" "baseball"
    "basketball" "bauhaus" "bayern" "bb" "bbc" "bbt" "bbva" "bcg" "bcn" "bd"
    "be" "beats" "beauty" "beer" "bentley" "berlin" "best" "bestbuy" "bet" "bf"
    "bg" "bh" "bharti" "bi" "bible" "bid" "bike" "bing" "bingo" "bio" "biz" "bj"
    "black" "blackfriday" "blockbuster" "blog" "bloomberg" "blue" "bm" "bms"
    "bmw" "bn" "bnpparibas" "bo" "boats" "boehringer" "bofa" "bom" "bond" "boo"
    "book" "booking" "bosch" "bostik" "boston" "bot" "boutique" "box" "br"
    "bradesco" "bridgestone" "broadway" "broker" "brother" "brussels" "bs" "bt"
    "build" "builders" "business" "buy" "buzz" "bv" "bw" "by" "bz" "bzh" "ca"
    ...
    "cba" "cbn" "cbre" "cc" "cd" "center" "ceo" "cern" "cf" "cfa" "cfd" "cg"
    "ch" "chanel" "channel" "charity" "chase" "chat" "cheap" "chintai"
    "christmas" "chrome" "church" "ci" "cipriani" "circle" "cisco" "citadel"
    "citi" "citic" "city" "ck" "cl" "claims" "cleaning" "click" "clinic"
    "clinique" "clothing" "cloud" "club" "clubmed" "cm" "cn" "co" "coach"
    "codes" "coffee" "college" "cologne" "com" "commbank" "community" "company"
    ...
    "crs" "cruise" "cruises" "cu" "cuisinella" "cv" "cw" "cx" "cy" "cymru"
    "cyou" "cz" "dabur" "dad" "dance" "data" "date" "dating" "datsun" "day"
    "dclk" "dds" "de" "deal" "dealer" "deals" "degree" "delivery" "dell"
    "deloitte" "delta" "democrat" "dental" "dentist" "desi" "design" "dev" "dhl"
    "diamonds" "diet" "digital" "direct" "directory" "discount" "discover"
    "dish" "diy" "dj" "dk" "dm" "dnp" "do" "docs" "doctor" "dog" "domains" "dot"
    "download" "drive" "dtv" "dubai" "dunlop" "dupont" "durban" "dvag" "dvr"
    "dz" "earth" "eat" "ec" "eco" "edeka" "edu" "education" "ee" "eg" "email"
    ...
    "fedex" "feedback" "ferrari" "ferrero" "fi" "fidelity" "fido" "film" "final"
    "finance" "financial" "fire" "firestone" "firmdale" "fish" "fishing" "fit"
    "fitness" "fj" "fk" "flickr" "flights" "flir" "florist" "flowers" "fly" "fm"
    "fo" "foo" "food" "football" "ford" "forex" "forsale" "forum" "foundation"
    "fox" "fr" "free" "fresenius" "frl" "frogans" "frontier" "ftr" "fujitsu"
    "fun" "fund" "furniture" "futbol" "fyi" "ga" "gal" "gallery" "gallo"
    "gallup" "game" "games" "gap" "garden" "gay" "gb" "gbiz" "gd" "gdn" "ge"
    "gea" "gent" "genting" "george" "gf" "gg" "ggee" "gh" "gi" "gift" "gifts"
    "gives" "giving" "gl" "glass" "gle" "global" "globo" "gm" "gmail" "gmbh"
    "gmo" "gmx" "gn" "godaddy" "gold" "goldpoint" "golf" "goo" "goodyear" "goog"
    ...
    "hospital" "host" "hosting" "hot" "hotels" "hotmail" "house" "how" "hr"
    "hsbc" "ht" "hu" "hughes" "hyatt" "hyundai" "ibm" "icbc" "ice" "icu" "id"
    "ie" "ieee" "ifm" "ikano" "il" "im" "imamat" "imdb" "immo" "immobilien" "in"
    "inc" "industries" "infiniti" "info" "ing" "ink" "institute" "insurance"
    ...
    "kaufen" "kddi" "ke" "kerryhotels" "kerrylogistics" "kerryproperties" "kfh"
    "kg" "kh" "ki" "kia" "kids" "kim" "kindle" "kitchen" "kiwi" "km" "kn"
    "koeln" "komatsu" "kosher" "kp" "kpmg" "kpn" "kr" "krd" "kred" "kuokgroup"
    "kw" "ky" "kyoto" "kz" "la" "lacaixa" "lamborghini" "lamer" "lancaster"
    ...
    "lilly" "limited" "limo" "lincoln" "link" "lipsy" "live" "living" "lk" "llc"
    ...
    "mini" "mint" "mit" "mitsubishi" "mk" "ml" "mlb" "mls" "mm" "mma" "mn" "mo"
    "mobi" "mobile" "moda" "moe" "moi" "mom" "monash" "money" "monster" "mormon"
    "mortgage" "moscow" "moto" "motorcycles" "mov" "movie" "mp" "mq" "mr" "ms"
    "msd" "mt" "mtn" "mtr" "mu" "museum" "music" "mv" "mw" "mx" "my" "mz" "na"
    "nab" "nagoya" "name" "natura" "navy" "nba" "nc" "ne" "nec" "net" "netbank"
    "netflix" "network" "neustar" "new" "news" "next" "nextdirect" "nexus" "nf"
    "nfl" "ng" "ngo" "nhk" "ni" "nico" "nike" "nikon" "ninja" "nissan" "nissay"
    "nl" "no" "nokia" "norton" "now" "nowruz" "nowtv" "np" "nr" "nra" "nrw"
    "ntt" "nu" "nyc" "nz" "obi" "observer" "office" "okinawa" "olayan"
    "olayangroup" "ollo" "om" "omega" "one" "ong" "onl" "online" "ooo" "open"
    "oracle" "orange" "org" "organic" "origins" "osaka" "otsuka" "ott" "ovh"
    "pa" "page" "panasonic" "paris" "pars" "partners" "parts" "party" "pay"
    "pccw" "pe" "pet" "pf" "pfizer" "pg" "ph" "pharmacy" "phd" "philips" "phone"
    "photo" "photography" "photos" "physio" "pics" "pictet" "pictures" "pid"
    "pin" "ping" "pink" "pioneer" "pizza" "pk" "pl" "place" "play" "playstation"
    "plumbing" "plus" "pm" "pn" "pnc" "pohl" "poker" "politie" "porn" "post"
    "pr" "pramerica" "praxi" "press" "prime" "pro" "prod" "productions" "prof"
    ...
    "samsclub" "samsung" "sandvik" "sandvikcoromant" "sanofi" "sap" "sarl" "sas"
    ...
    "tushu" "tv" "tvs" "tw" "tz" "ua" "ubank" "ubs" "ug" "uk" "unicom"
    "university" "uno" "uol" "ups" "us" "uy" "uz" "va" "vacations" "vana"
    "vanguard" "vc" "ve" "vegas" "ventures" "verisign" "versicherung" "vet"
    "vg" "vi" "viajes" "video" "vig" "viking" "villas" "vin" "vip" "virgin"
    "visa" "vision" "viva" "vivo" "vlaanderen" "vn" "vodka" "volvo" "vote"
    "voting" "voto" "voyage" "vu" "wales" "walmart" "walter" "wang" "wanggou"
    "watch" "watches" "weather" "weatherchannel" "webcam" "weber" "website"
    "wed" "wedding" "weibo" "weir" "wf" "whoswho" "wien" "wiki" "williamhill"
...
(def alpha-pattern "[a-z]")
(def digit-pattern "[0-9]")
(def hyphen-pattern "[-]")
(def alpha-digit-pattern
  (str "[" alpha-pattern digit-pattern "]"))
(def alpha-digit-hyphen-pattern
  (str "[" alpha-digit-pattern hyphen-pattern "]"))

(defn gen-top-level-domain-label []
  (gen/elements top-level-domain-labels))

(defn gen-lower-level-domain-label []
  (gen/fmap
    string/join
    (gen/frequency
      [[1 (sv-string/gen-character-string-unicode alpha-digit-pattern)]
       [20 (gen/tuple
             (sv-string/gen-character-string-unicode alpha-digit-pattern)
             (sv-string/gen-string-unicode alpha-digit-hyphen-pattern
